...
/*
  ...
  -----------------------------------------------------------------------------
  Ce script affiche le formulaire d'ajout d'un avatar.

  Fichier : src/page/avatar/add.php
 */
...
<body>
  <div class="container">
    ...
    <form action="<?php HTTP::url('/save') ?>" method="post" class="w-50" enctype="multipart/form-data">
      <div class="mb-3">
      ...
      <a href="<?php HTTP::url('/') ?>" class="btn btn-link text-black">annuler</a>
    </form>
